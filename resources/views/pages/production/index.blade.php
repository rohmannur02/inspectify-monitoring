...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            ...
            <h2 class="section-title">Production Per Shift</h2>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="float-left">
                                <form method="GET" action="{{ route('production.index') }}">
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Search By Schedule"
                                            name="schedule">
                            ...
                            <div class="btn flex mt-10">
                                <a href="{{ route('production.index') }}" class="btn btn-primary">Reset Search</a>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table-striped table">
                                    ...
                                    @php
                                    $createdAt =
                                    \Carbon\Carbon::parse($production->created_at)->timezone('Asia/Jakarta')->format('Y-m-d
                                    H:i:s');
                                    $updatedAt =
                                    \Carbon\Carbon::parse($production->updated_at)->timezone('Asia/Jakarta')->format('Y-m-d
                                    H:i:s')
                                    @endphp
