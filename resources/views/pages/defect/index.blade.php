    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-button">
                    <a href="{{ route('defect.create') }}"
                        class="btn btn-primary {{ Auth::user()->status == 'HOS' || Auth::user()->status == 'TL' ? "" : "disabled" }}">Add New Defect</a>
                </div>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
                    <div class="breadcrumb-item"><a href="#">Defect</a></div>
                    <div class="breadcrumb-item">All Defects</div>
                </div>
            </div>
            <div class="section-body">
                ...
                <h2 class="section-title">Defects</h2>
                <p class="section-lead">
                    You can manage all Defects, such as editing, deleting and more.
                </p>
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="card">
                                ...
                                <div class="float-left">
                                    <form method="GET" action="{{ route('defect.index') }}">
                                        <div class="input-group">
                                            <input type="text"
                                                class="form-control"
                                                placeholder="Search By Defect" name="defect">
