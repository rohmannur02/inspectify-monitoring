                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Choose a Size and Auto Update"
                                        id="pattern" name="pattern" readonly required>
                                    @error('pattern')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Choose a Size and Auto Update" class="form-control"
                                        id="item_code" name="item_code" readonly required>
                                    @error('item_code')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Choose a Size and Auto Update" class="form-control"
                                        id="marking_line" name="marking_line" readonly required>
                                    @error('marking_line')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <label>Serial</label>
                                    <input type="text" placeholder="Input Serial" class="form-control @error('serial')
                                        is-invalid
                                    @enderror" name="serial" required>
                                    @error('serial')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <label>Defect</label>
                                    <select class="form-control" name="defect" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <label>Mold</label>
                                    <input type="text" placeholder="Input Mold" class="form-control @error('mold')
                                        is-invalid
                                    @enderror" name="mold" required>
                                    @error('mold')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="author" name="author" readonly class="form-control @error('author')
                                        is-invalid
